...
impl super::proxy::Proxy for ProxyNone {
    fn update_nodes(
        &mut self,
        _nodes: &std::collections::HashMap<uuid::Uuid, crate::client_desc::ClientDesc>,
    ) {
    }
    fn update_resource_providers(
        &mut self,
        _resource_providers: &std::collections::HashMap<
            String,
    ...
    fn update_active_instances(
        &mut self,
        _active_instances: &std::collections::HashMap<
            uuid::Uuid,
    ...
    fn update_dependency_graph(
        &mut self,
        _dependency_graph: &std::collections::HashMap<
            uuid::Uuid,
    ...
    fn push_node_health(
        &mut self,
        _node_id: &uuid::Uuid,
        _node_health: edgeless_api::node_registration::NodeHealthStatus,
    ) {
    }
    fn push_performance_samples(
        &mut self,
        _node_id: &uuid::Uuid,
        _performance_samples: edgeless_api::node_registration::NodePerformanceSamples,
    ) {
    }
