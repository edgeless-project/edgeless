...
pub enum DomainSubscriberRequest {
    ...
    RegisterOrcSender(
        futures::channel::mpsc::UnboundedSender<crate::orchestrator::OrchestratorRequest>,
    ),
    Refresh(),
}
...
impl DomainSubscriber {
            ...
            match req {
                ...
                DomainSubscriberRequest::Refresh() => {
                    ...
                    match client
                        ...
                        .update_domain(update_domain_request)
                        .await
                    {
                        Ok(response) => {
                            match response {
    ...
    pub fn get_subscriber_sender(
        &mut self,
    ) -> futures::channel::mpsc::UnboundedSender<DomainSubscriberRequest> {
        self.sender.clone()
    }
}
