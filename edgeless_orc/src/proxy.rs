...
pub type PerformanceSamples =
    std::collections::HashMap<String, Vec<(chrono::DateTime<chrono::Utc>, String)>>;
...
pub trait Proxy: Sync + Send {
    ...
    fn fetch_performance_samples(
        &mut self,
    ) -> std::collections::HashMap<String, PerformanceSamples>;
    ...
    fn fetch_nodes_to_instances(
        &mut self,
    ) -> std::collections::HashMap<edgeless_api::function_instance::NodeId, Vec<Instance>>;
