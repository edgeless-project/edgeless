...
pub trait ResourceConfigurationAPIDyn {
    ...
    ) -> core::pin::Pin<alloc::boxed::Box<dyn core::future::Future<Output = Result<edgeless_api_core::instance_id::InstanceId, ()>> + 'a>>;
    fn stop(
        &mut self,
        resource_id: edgeless_api_core::instance_id::InstanceId,
    ) -> core::pin::Pin<alloc::boxed::Box<dyn core::future::Future<Output = Result<(), ()>> + '_>>;
}
