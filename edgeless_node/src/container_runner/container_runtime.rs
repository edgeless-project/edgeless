...
impl ContainerRuntime {
    ...
    pub fn new(
        ...
        Box<dyn edgeless_api::api::container_runtime::ContainerRuntimeAPI + Send>,
    ) {
...
impl edgeless_api::api::container_runtime::ContainerRuntimeAPI for ContainerRuntimeClient {
