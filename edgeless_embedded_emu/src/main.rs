...
fn main() -> ! {
    ...
    static EXECUTOR_RAW: static_cell::StaticCell<embassy_executor::Executor> =
...
async fn edgeless(spawner: embassy_executor::Spawner) {
    ...
    static RX_META_RAW: static_cell::StaticCell<[embassy_net::udp::PacketMetadata; 10]> =
        static_cell::StaticCell::new();
    ...
    static TX_META_RAW: static_cell::StaticCell<[embassy_net::udp::PacketMetadata; 10]> =
        static_cell::StaticCell::new();
    ...
    static STACK_RESOURCES_RAW: static_cell::StaticCell<embassy_net::StackResources<3>> =
        static_cell::StaticCell::new();
    static STACK_RAW: static_cell::StaticCell<
        embassy_net::Stack<embassy_net_tuntap::TunTapDevice>,
    > = static_cell::StaticCell::new();
    ...
    static RESOURCES_RAW: static_cell::StaticCell<
        [&'static mut dyn edgeless_embedded::resource::ResourceDyn; 2],
    > = static_cell::StaticCell::new();
    let resources = RESOURCES_RAW.init_with(|| [display, sensor_scd30]);

    let resource_registry =
        edgeless_embedded::agent::EmbeddedAgent::new(spawner, NODE_ID, resources).await;
