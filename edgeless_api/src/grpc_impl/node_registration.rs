...
// TODO: the struct name is the same as the one generated by protobuf
// definitions - can get confusing; names should be different
#[derive(Clone)]
pub struct NodeRegistrationClient {
    // NOTE: note the grpc_impl::api prefix - this uses the client stubs
    // generated by tonic
    client: crate::grpc_impl::grpc_api_stubs::node_registration_client::NodeRegistrationClient<tonic::transport::Channel>,
    server_addr: String,
}
...
impl NodeRegistrationClient {
    pub async fn new(server_addr: &str) -> Self {
        loop {
            match crate::grpc_impl::grpc_api_stubs::node_registration_client::NodeRegistrationClient::connect(server_addr.to_string()).await {
                Ok(client) => {
                ...
                Err(e) => {
                    log::warn!("Waiting for NodeRegistrationAPI to connect: {e}");
    ...
    async fn reconnect(&mut self) -> Result<(), anyhow::Error> {
        ...
        loop {
            ...
            match crate::grpc_impl::grpc_api_stubs::node_registration_client::NodeRegistrationClient::connect(self.server_addr.clone()).await {
                Ok(client) => {
                    self.client = client.max_decoding_message_size(usize::MAX);
                    return Ok(());
                }
                Err(e) => {
                    log::warn!("Waiting for NodeRegistrationAPI to reconnect: {}", e);
...
impl crate::node_registration::NodeRegistrationAPI for NodeRegistrationClient {
    async fn update_node(
        ...
        // TODO: ad-hoc, could use a refactor
        loop {
            let serialized_event = serialize_update_node_request(&request);
            let res = tokio::time::timeout(
                Duration::from_millis(TIMEOUT),
                self.client.update_node(tonic::Request::new(serialized_event)),
            )
            .await;
            // first Result layer is for the tokio::time::timeout
            if let Ok(grpc_response) = res {
                let to_return = match grpc_response {
                    Ok(ok_resp) => Some(ok_resp.into_inner()),
                    Err(err) => {
                        log::error!("got a response but it was an error");
                        None
                    },
                };
                if let Some(ret) = to_return {
                    return parse_update_node_response(&ret);
                }
                ...
                if let Ok(_) = res {
                    ...
                    return Err(anyhow::anyhow!("Error when reconnecting to the orchestrator at node {}", self.server_addr));
                }
            }            
        }
    }
...
#[async_trait::async_trait]
impl crate::grpc_impl::grpc_api_stubs::node_registration_server::NodeRegistration for NodeRegistrationAPIService {
    async fn update_node(
        &self,
        request: tonic::Request<crate::grpc_impl::grpc_api_stubs::UpdateNodeRequest>,
    ) -> Result<tonic::Response<crate::grpc_impl::grpc_api_stubs::UpdateNodeResponse>, tonic::Status> {
...
// NOTE: these types of conversion seem very redundant
fn parse_node_capabilities(api_instance: &crate::grpc_impl::grpc_api_stubs::NodeCapabilities) -> crate::node_registration::NodeCapabilities {
...
fn serialize_node_capabilities(req: &crate::node_registration::NodeCapabilities) -> crate::grpc_impl::grpc_api_stubs::NodeCapabilities {
    crate::grpc_impl::grpc_api_stubs::NodeCapabilities {
...
fn parse_update_node_request(api_instance: &crate::grpc_impl::grpc_api_stubs::UpdateNodeRequest) -> anyhow::Result<crate::node_registration::UpdateNodeRequest> {
...
fn serialize_update_node_response(req: &crate::node_registration::UpdateNodeResponse) -> crate::grpc_impl::grpc_api_stubs::UpdateNodeResponse {
    match req {
        crate::node_registration::UpdateNodeResponse::ResponseError(err) => crate::grpc_impl::grpc_api_stubs::UpdateNodeResponse {
            response_error: Some(crate::grpc_impl::grpc_api_stubs::ResponseError {
                summary: err.summary.clone(),
                detail: err.detail.clone(),
            }),
        },
        crate::node_registration::UpdateNodeResponse::Accepted => crate::grpc_impl::grpc_api_stubs::UpdateNodeResponse { response_error: None },
    }
}

fn parse_update_node_response(
    api_instance: &crate::grpc_impl::grpc_api_stubs::UpdateNodeResponse,
) -> anyhow::Result<crate::node_registration::UpdateNodeResponse> {
...
fn serialize_update_node_request(req: &crate::node_registration::UpdateNodeRequest) -> crate::grpc_impl::grpc_api_stubs::UpdateNodeRequest {
    crate::grpc_impl::grpc_api_stubs::UpdateNodeRequest {
...
fn parse_resource_provider_specification(
    api_spec: &crate::grpc_impl::grpc_api_stubs::ResourceProviderSpecification,
...
) -> crate::grpc_impl::grpc_api_stubs::ResourceProviderSpecification {
    crate::grpc_impl::grpc_api_stubs::ResourceProviderSpecification {
...
pub fn parse_node_health_status(api_instance: &crate::grpc_impl::grpc_api_stubs::NodeHealthStatus) -> crate::node_registration::NodeHealthStatus {
...
fn serialize_node_health_status(req: &crate::node_registration::NodeHealthStatus) -> crate::grpc_impl::grpc_api_stubs::NodeHealthStatus {
    crate::grpc_impl::grpc_api_stubs::NodeHealthStatus {
...
pub fn parse_sample(api_instance: &crate::grpc_impl::grpc_api_stubs::Sample) -> crate::node_registration::Sample {
...
pub fn parse_node_performance_samples(
    api_instance: &crate::grpc_impl::grpc_api_stubs::NodePerformanceSamples,
...
fn serialize_sample(req: &crate::node_registration::Sample) -> crate::grpc_impl::grpc_api_stubs::Sample {
    crate::grpc_impl::grpc_api_stubs::Sample {
...
fn serialize_node_performance_samples(req: &crate::node_registration::NodePerformanceSamples) -> crate::grpc_impl::grpc_api_stubs::NodePerformanceSamples {
    crate::grpc_impl::grpc_api_stubs::NodePerformanceSamples {
        function_execution_times: req
            .function_execution_times
            .iter()
            .map(|(id, samples)| crate::grpc_impl::grpc_api_stubs::Samples {
                id: id.to_string(),
