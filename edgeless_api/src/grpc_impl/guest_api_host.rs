...
impl crate::grpc_impl::grpc_api_stubs::guest_api_host_server::GuestApiHost for GuestAPIHostService {
    ...
    async fn cast_raw(&self, event: tonic::Request<crate::grpc_impl::grpc_api_stubs::OutputEventDataRaw>) -> Result<tonic::Response<()>, tonic::Status> {
    ...
    async fn telemetry_log(&self, event: tonic::Request<crate::grpc_impl::grpc_api_stubs::TelemetryLogEvent>) -> Result<tonic::Response<()>, tonic::Status> {
    ...
    async fn delayed_cast(&self, event: tonic::Request<crate::grpc_impl::grpc_api_stubs::DelayedEventData>) -> Result<tonic::Response<()>, tonic::Status> {
...
pub fn parse_output_event_data(api_instance: &crate::grpc_impl::grpc_api_stubs::OutputEventData) -> anyhow::Result<crate::guest_api_host::OutputEventData> {
...
pub fn parse_output_event_data_raw(
    api_instance: &crate::grpc_impl::grpc_api_stubs::OutputEventDataRaw,
...
pub fn parse_telemetry_log_event(
    api_instance: &crate::grpc_impl::grpc_api_stubs::TelemetryLogEvent,
...
pub fn parse_delayed_event_data(api_instance: &crate::grpc_impl::grpc_api_stubs::DelayedEventData) -> anyhow::Result<crate::guest_api_host::DelayedEventData> {
...
pub fn parse_sync_data(api_instance: &crate::grpc_impl::grpc_api_stubs::SyncData) -> anyhow::Result<crate::guest_api_host::SyncData> {
