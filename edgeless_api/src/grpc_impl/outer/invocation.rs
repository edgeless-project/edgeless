...
impl InvocationConverters {
    fn parse_api_event(
        api_event: &crate::grpc_impl::api::Event,
    ) -> anyhow::Result<crate::invocation::Event> {
    ...
    fn parse_api_event_data(
        api_event_data: &crate::grpc_impl::api::EventData,
    ) -> anyhow::Result<crate::invocation::EventData> {
        match api_event_data.event_type {
            TYPE_CALL => Ok(crate::invocation::EventData::Call(
                api_event_data.payload.to_string(),
            )),
            TYPE_CAST => Ok(crate::invocation::EventData::Cast(
                api_event_data.payload.to_string(),
            )),
            TYPE_CALL_RET => Ok(crate::invocation::EventData::CallRet(
                api_event_data.payload.to_string(),
            )),
    ...
    fn encode_crate_event(crate_event: &crate::invocation::Event) -> crate::grpc_impl::api::Event {
        crate::grpc_impl::api::Event {
            ...
            created: Some(CommonConverters::serialize_event_timestamp(
                &crate_event.created,
            )),
            metadata: Some(crate::grpc_impl::api::EventSerializedMetadata::from(
                &crate_event.metadata,
            )),
        }
    }

    fn encode_crate_event_data(
        crate_event: &crate::invocation::EventData,
...
pub struct InvocationAPIClient {
    client: crate::grpc_impl::api::function_invocation_client::FunctionInvocationClient<
...
impl crate::invocation::InvocationAPI for InvocationAPIClient {
    async fn handle(
        ...
        let res = self
            .client
            .handle(tonic::Request::new(serialized_event))
            .await;
        match res {
...
#[async_trait::async_trait]
impl crate::grpc_impl::api::function_invocation_server::FunctionInvocation
    for InvocationAPIServerHandler
{
    async fn handle(
        &self,
        request: tonic::Request<crate::grpc_impl::api::Event>,
