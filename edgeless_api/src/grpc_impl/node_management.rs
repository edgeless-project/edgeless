...
impl crate::node_management::NodeManagementAPI for NodeManagementClient {
    async fn update_peers(&mut self, request: crate::node_management::UpdatePeersRequest) -> anyhow::Result<()> {
        loop {
            ...
            let res = tokio::time::timeout(Duration::from_millis(TIMEOUT), self.client.update_peers(tonic::Request::new(serialized_event))).await;
...
impl crate::grpc_impl::grpc_api_stubs::node_management_server::NodeManagement for NodeManagementAPIService {
    async fn update_peers(&self, request: tonic::Request<crate::grpc_impl::grpc_api_stubs::UpdatePeersRequest>) -> Result<tonic::Response<()>, tonic::Status> {
...
pub fn parse_update_peers_request(
    api_instance: &crate::grpc_impl::grpc_api_stubs::UpdatePeersRequest,
