...
impl crate::api::container_runtime::ContainerRuntimeAPI for ContainerRuntimeAPIClient {
...
impl GuestAPIHostServer {
    pub fn run(
        container_runtime_api: Box<dyn crate::api::container_runtime::ContainerRuntimeAPI + Send>,
