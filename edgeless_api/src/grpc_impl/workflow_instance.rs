...
impl WorkflowInstanceConverters {
    pub fn parse_workflow_id(api_id: &crate::grpc_impl::api::WorkflowId) -> crate::workflow_instance::WorkflowId {
        crate::workflow_instance::WorkflowId {
            workflow_id: uuid::Uuid::parse_str(&api_id.workflow_id).unwrap(),
        }
    }
    pub fn parse_workflow_function(api_function: &crate::grpc_impl::api::WorkflowFunction) -> crate::workflow_instance::WorkflowFunction {
        crate::workflow_instance::WorkflowFunction {
            ...
            function_class_specification: crate::grpc_impl::function_instance::FunctonInstanceConverters::parse_function_class_specification(
                &api_function.function_class.as_ref().unwrap(),
            ),
    ...
    pub fn parse_workflow_spawn_request(api_request: &crate::grpc_impl::api::SpawnWorkflowRequest) -> crate::workflow_instance::SpawnWorkflowRequest {
        crate::workflow_instance::SpawnWorkflowRequest {
            workflow_id: WorkflowInstanceConverters::parse_workflow_id(&api_request.workflow_id.as_ref().unwrap()),
    ...
    ) -> crate::workflow_instance::WorkflowFunctionMapping {
        crate::workflow_instance::WorkflowFunctionMapping {
            function_alias: api_mapping.function_alias.to_string(),
            instances: api_mapping
                .instances
                .iter()
                .map(|fun| crate::grpc_impl::function_instance::FunctonInstanceConverters::parse_function_id(fun))
                .collect(),
        }
    }

    pub fn parse_workflow_instance(api_instance: &crate::grpc_impl::api::WorkflowInstanceStatus) -> crate::workflow_instance::WorkflowInstance {
        crate::workflow_instance::WorkflowInstance {
            workflow_id: WorkflowInstanceConverters::parse_workflow_id(&api_instance.workflow_id.as_ref().unwrap()),
...
impl WorkflowInstanceAPIClient {
    pub async fn new(server_addr: &str) -> Self {
        let client = crate::grpc_impl::api::workflow_instance_client::WorkflowInstanceClient::connect(server_addr.to_string())
            .await
            .unwrap();
        Self { client }
    }
...
impl crate::workflow_instance::WorkflowInstanceAPI for WorkflowInstanceAPIClient {
    async fn start_workflow_instance(
        ...
        match ret {
            Ok(ret) => {
                return Ok(crate::grpc_impl::workflow_instance::WorkflowInstanceConverters::parse_workflow_instance(
                    &ret.into_inner(),
                ))
            }
...
pub struct WorkflowInstanceAPIServer {
    pub root_api: tokio::sync::Mutex<Box<dyn crate::workflow_instance::WorkflowInstanceAPI + Send>>,
}
...
impl crate::grpc_impl::api::workflow_instance_server::WorkflowInstance for WorkflowInstanceAPIServer {
    async fn start_workflow_instance(
        ...
        let ret = self
            ...
            .start_workflow_instance(
                crate::grpc_impl::workflow_instance::WorkflowInstanceConverters::parse_workflow_spawn_request(&request.into_inner()),
            )
            .await;
        match ret {
    ...
    async fn stop_workflow_instance(
        ...
        let ret = self
            ...
            .lock()
            .await
            .stop_workflow_instance(crate::grpc_impl::workflow_instance::WorkflowInstanceConverters::parse_workflow_id(
