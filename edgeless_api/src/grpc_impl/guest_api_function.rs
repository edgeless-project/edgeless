...
impl crate::grpc_impl::grpc_api_stubs::guest_api_function_server::GuestApiFunction for GuestAPIFunctionService {
    ...
    async fn init(&self, init_data: tonic::Request<crate::grpc_impl::grpc_api_stubs::FunctionInstanceInit>) -> Result<tonic::Response<()>, tonic::Status> {
...
pub fn parse_boot_data(api_instance: &crate::grpc_impl::grpc_api_stubs::BootData) -> anyhow::Result<crate::guest_api_function::BootData> {
...
pub fn parse_function_instance_init(
    api_instance: &crate::grpc_impl::grpc_api_stubs::FunctionInstanceInit,
...
pub fn parse_input_event_data(api_instance: &crate::grpc_impl::grpc_api_stubs::InputEventData) -> anyhow::Result<crate::guest_api_function::InputEventData> {
...
fn serialize_function_instance_init(init_data: &crate::guest_api_function::FunctionInstanceInit) -> crate::grpc_impl::grpc_api_stubs::FunctionInstanceInit {
