...
if [[ -f "$ROOT_DIR/functions/work_splitter/work_splitter.wasm" && -f "$ROOT_DIR/functions/calculator/calculator.wasm" && -f "$ROOT_DIR/functions/http_read_parameters/http_read_parameters.wasm" ]]; then
