...
def save_differences(differences, output_file, producer_first_timestamp):
...
def main():
    ...
    producer_timestamps = [line.strip().split(' - Payload: ')[0] for line in producer_lines[0:]]
    consumer_timestamps = [line.strip().split(' - Payload: ')[0] for line in consumer_lines[0:]]
    ...
    save_differences(differences, args.output, producer_timestamps[0] + '\n')
